...
function getContentForRoutes(endpoints, globalArgs, rioTypeOfEndpoint, rioDescriptionOfEndpoint, rioArgsForEndpoint, rioExampleResultOfEndpoint) {
  let content = '';
...
function writeModule(module, rc, globalArgs, moduleRoutes, rioTypeOfEndpoint, rioDescriptionOfEndpoint, rioArgsForEndpoint, rioExampleResultOfEndpoint) {
  let content = `# ${module}\n\n`;
  ...
  content += getContentForRoutes(moduleRoutes, globalArgs, rioTypeOfEndpoint, rioDescriptionOfEndpoint, rioArgsForEndpoint, rioExampleResultOfEndpoint);
  const fileName = `${pathForModule(module)}-API.md`;
  writeToFile(fileName, content);
}

function writeNoModules(cnt, globalArgs, rioArgsForEndpoint, rioTypeOfEndpoint, rioDescriptionOfEndpoint, rioExampleResultOfEndpoint) {
  let content = cnt;
  const endpoints = Object.keys(rioArgsForEndpoint);
  endpoints.sort();

  content += getContentForRoutes(endpoints, globalArgs, rioTypeOfEndpoint, rioDescriptionOfEndpoint, rioArgsForEndpoint, rioExampleResultOfEndpoint);
...
function writeREADME(path, paths, app, appName, globalArgs, rioArgsForEndpoint, rioTypeOfEndpoint, rioDescriptionOfEndpoint, rioExampleResultOfEndpoint, rioStatusOfEndpoint, rioAvailabilityOfEndpoint) {
  ...
  if (modules.length > 0) {
    ...
    fs.mkdir('API-Modules', { recursive: true }, (err) => {
      if (err) {
        ...
        for (let i = 0; i < modules.length; i += 1) {
          ...
          writeModule(module, rc, globalArgs, moduleRoutes, rioTypeOfEndpoint, rioDescriptionOfEndpoint, rioArgsForEndpoint, rioExampleResultOfEndpoint);
        }
        writeModule('Misc', rc, globalArgs, miscRoutes, rioTypeOfEndpoint, rioDescriptionOfEndpoint, rioArgsForEndpoint, rioExampleResultOfEndpoint);
    ...
    writeNoModules(content, globalArgs, rioArgsForEndpoint, rioTypeOfEndpoint, rioDescriptionOfEndpoint, rioExampleResultOfEndpoint);
  }
}
